                        ...
                        <table id="shopping-cart-table" class="cart items data table" >
                            <thead>
                                <tr>
                                    ...
                                    <th class="col qty" scope="col"><span>Commentaire</span></th>
                                    <th class="col subtotal" scope="col"><span>Réponse</span></th>
                                </tr>
                            </thead>    
                            ...
                            @forelse($commandes as $commande)
                                ...
                                <tbody class="cart item">
                                    <tr class="item-info">
                                        ...
                                        <td class="col price" data-th="Price" style="    width: 38%;">
                                        ...
                                        <td class="col subtotal" data-th="Subtotal">
                                            ...
                                            <span class="price-excluding-tax" >
                                                <span class="cart-price">
                                                    ...
                                                    <a href="/restaurant/commande/accepter/{{ $commande->id }}"class="btn btn-success" >accepter </a>
                                                    <a href="/restaurant/commande/refuser/{{ $commande->id }}" class="btn btn-danger">refuser </a>
