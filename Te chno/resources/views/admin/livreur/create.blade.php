                        ...
                        <div class="card">
                            ...
                            <form method="post" action="{{ route('livreur.store') }}"enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <input type="text" name="numéro_tel" id="image" class="form-control" />

                                    
                                    <label  class="form-label">Adresse</label>
                                    <input type="text" name="adresse" id="image" class="form-control" />

                                    
                                    <label  class="form-label">Email</label>
                                    <input type="text" name="email" id="image" class="form-control" />

                                    
                                    <label  class="form-label">Password</label>
                                    <input type="password" name="password" id="image" class="form-control" />
