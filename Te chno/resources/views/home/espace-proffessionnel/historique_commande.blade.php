                                        ...
                                        <td class="col subtotal" data-th="Subtotal">
                                            ...
                                            <span class="price-excluding-tax" >
                                                ...
                                                @if ($commande->confirmation == 0) 
                                                    <span class="label" style="color: darkorange">Commande en attente </span>
                                                @endif
                                                        
                                                @if      ($commande->confirmation == 1) 
                                                    <span class="label" style="color:dodgerblue">Commande acceptée,livreur en attente </span>
                                                @endif
                                                @if      ($commande->confirmation == 2) 
                                                    <span class="label" style="color: rgb(235, 0, 0)">Commande refusée</span>
                                                @endif
                                                @if      ($commande->confirmation == 3) 
                                                <span class="label" style="color: rgb(0, 247, 0)">Commande acceptée : <a style="color: rgb(16, 211, 16)" href="/commande/detail-restaurant/{{$commande->id}}">Voir plus de Détails</a> </u></b> </span>
                                                @endif
